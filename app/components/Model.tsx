...
export default function Model() {
  return (
    <div className="h-[400px] sm:h-full bg-customBlack2 flex m-auto w-full rounded-lg relative overflow-hidden">
      ...
      <div className="w-[250px] xs:w-[390px] sm:w-[480px] md:w-[580px] Xl:w-[680px] text-center mx-auto space-y-4 sm:space-y-7 py-8 sm:py-24 mt-0 md:mt-4 relative z-10 flex flex-col gap-12 sm:gap-8 Xl:gap-16">
        <div>
          <HighLightText2
